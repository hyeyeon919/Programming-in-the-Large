...
/**
 * The FileFormatException class is an exception that is thrown when a file being read or processed is not in the expected format.
 * This class extends the base Exception class in order to provide custom error handling for file format errors.
 */
public class FileFormatException extends Exception {
     ...
     * These should be used to construct a message for the superclass,
     * in the format: "message text (line: line number)"
     *
     * @param message A String containing the detail message (which is saved for later retrieval by the getMessage() method)
     ...
     * Message and line number should be used to construct a message for the superclass,
     * in the format: "message text (line: line number)"
     *
     * @param message A String containing the detail message (which is saved for later retrieval by the getMessage() method)
